...
shutil.copytree('inputs', OUTPUT_DIR, dirs_exist_ok=True)

# copy forcing files, preserving folder structure
shutil.copytree('forcing', os.path.join(OUTPUT_DIR, 'forcing'), dirs_exist_ok=True)
